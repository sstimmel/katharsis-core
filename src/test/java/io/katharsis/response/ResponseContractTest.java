...
public class ResponseContractTest {
    ...
    public void LinkageContainerContainerEqualsContract() throws NoSuchFieldException {
        ...
        @SuppressWarnings("unchecked") RegistryEntry registryEntryRed = new RegistryEntry(resourceInformationRed, null, null, null);
        @SuppressWarnings("unchecked") RegistryEntry registryEntryBlack = new RegistryEntry(resourceInformationBlack, null, null, null);
