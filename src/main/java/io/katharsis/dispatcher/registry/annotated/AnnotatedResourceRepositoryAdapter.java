...
public class AnnotatedResourceRepositoryAdapter<T, ID extends Serializable> extends AnnotatedRepositoryAdapter<T> {
    ...
    public Object findOne(ID id, QueryParams queryParams) {
        return invokeOperation(findOneMethod, new Object[]{id}, queryParams);
    }

    public Object findAll(QueryParams queryParams) {
        return invokeOperation(findAllMethod, new Object[]{}, queryParams);
    }

    public Object findAll(Iterable<ID> ids, QueryParams queryParams) {
        return invokeOperation(findAllWithIds, new Object[]{ids}, queryParams);
    }

    public <S extends T> Object save(S entity) {
        return invokeOperation(saveMethod, new Object[]{entity});
    }

    public void delete(ID id, QueryParams queryParams) {
        invokeOperation(deleteMethod, new Object[]{id}, queryParams);
    }
}
