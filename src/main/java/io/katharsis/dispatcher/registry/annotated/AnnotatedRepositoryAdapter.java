...
public abstract class AnnotatedRepositoryAdapter<T> implements LinksRepository<T>, MetaRepository<T> {
    ...
    public LinksInformation getLinksInformation(Iterable<T> resources, QueryParams queryParams) {
        ...
        Object[] methodParameters = parametersFactory
                .buildParameters(new Object[]{resources}, linksMethod, queryParams);
    ...
    public MetaInformation getMetaInformation(Iterable<T> resources, QueryParams queryParams) {
        ...
        Object[] methodParameters = parametersFactory
                .buildParameters(new Object[]{resources}, metaMethod, queryParams);
    ...
    protected <TYPE> TYPE invokeOperation(Method foundMethod,
        ...
        Object[] methodParameters = parametersFactory.buildParameters(firstParameters, foundMethod);
        return invoke(foundMethod, methodParameters);
    }

    protected <TYPE> TYPE invokeOperation(Method foundMethod, Object[] firstParameters, QueryParams queryParams) {
        Object[] methodParameters = parametersFactory.buildParameters(firstParameters, foundMethod, queryParams);
        return invoke(foundMethod, methodParameters);
    }
